...
const TYPE_LABELS = {
  ...
  'commit-add': { label: 'Hard commitment added', variant: 'warn' },
  'commit-edit': { label: 'Hard commitment edited', variant: 'warn' },
  'commit-delete': { label: 'Hard commitment removed', variant: 'danger' },
  adjust: { label: 'Manual adjustment', variant: 'info' },
  'adjust-clear': { label: 'Adjustment cleared', variant: 'default' },
  lock: { label: 'Locked', variant: 'warn' },
